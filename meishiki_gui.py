...
from jcc import japanese_calendar_converter as jcc

ctk.set_appearance_mode("system")
ctk.set_default_color_theme("blue")

app = ctk.CTk()
app.geometry("780x160")
...
def cb1_selected(event):
    ...
    # combobox_6.set(dict[combobox_1.get()][round(len(dict[combobox_1.get()]) / 2)])
...
button_1 = ctk.CTkButton(master=app, command=button_callback, text="命式生成", width=100)
